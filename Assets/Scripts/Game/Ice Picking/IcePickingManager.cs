...
namespace Game.Ice_Picking
{
    ...
    public class IcePickingManager : MonoBehaviour
    {
        ...
        public void ChopAction(Sides side)
        {
            ...
            IceBlock.IceBlockVariation variation = _icePillarQueue.Peek().Variation;
        ...
        private IceBlock.IceBlockVariation DetermineSpikeVariation()
        {
            // The first X blocks have no spikes.
            if (_icePillarQueue.Count < _firstSpikeHeight)
                return IceBlock.IceBlockVariation.NoSpike;
            ...
            if (_currentSpikeSide == Sides.Left)
                return IceBlock.IceBlockVariation.LeftSpike;
            else
                return IceBlock.IceBlockVariation.RightSpike;
        }
